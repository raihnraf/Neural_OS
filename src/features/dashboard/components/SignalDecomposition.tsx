  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-8">
        <h4 className="text-sm font-bold uppercase tracking-widest text-on-surface">Live Signal Decomposition</h4>
        <div className="flex gap-2">
          <span className="w-3 h-3 rounded-full bg-primary border border-white/10"></span>
          <span className="w-3 h-3 rounded-full bg-secondary border border-white/10"></span>
          <span className="w-3 h-3 rounded-full bg-tertiary border border-white/10"></span>
        </div>
      </div>
