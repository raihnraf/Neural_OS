...
export const MagneticButton = forwardRef<HTMLButtonElement, MagneticButtonProps>(
  ({ className, variant = 'primary', size = 'md', shimmer = false, children, ...props }, ref) => {
    ...
    const variants = {
      ...
      outline: 'border border-outline-variant/30 text-primary hover:bg-surface-container-high focus:ring-outline',
      ghost: 'text-on-surface-variant hover:text-on-surface hover:bg-surface-container-high/50 focus:ring-outline',
    }
