    ...
    <main className="pt-16 bg-background min-h-screen">
      ...
      <div className="max-w-[1440px] mx-auto px-8 py-20">
        ...
        <header className="mb-20 max-w-3xl">
          ...
          >
            Access technical specifications, deployment frameworks, and market insights for the
            planetary-scale neural operating system.
          </motion.p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary-container/5 blur-[100px] pointer-events-none" />
            <div className="relative z-10 flex flex-col h-full justify-between">
              <div>
                ...
                <p className="text-on-surface-variant max-w-md mb-8">
                  Complete API references, SDK implementations, and system architecture diagrams for
                  building autonomous nodes on Neural OS.
                </p>
              </div>
          ...
          >
            ...
            <div className="p-8 flex flex-col flex-grow">
              ...
              <p className="text-on-surface-variant text-sm leading-relaxed mb-6">
                Explore our breakthrough in decentralized compute orchestration and how we solved
              ...
              <div className="mt-auto flex items-center justify-between">
                ...
                >
                  Read Post <MaterialSymbols icon="arrow_forward" className="text-sm" />
                </Link>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-col h-full">
              ...
              >
                Open Portal <MaterialSymbols icon="open_in_new" className="text-xs" />
              </MagneticButton>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed mb-8">
                Our resources are crafted to accelerate the transition from static cloud services to
                dynamic neural environments. Every whitepaper and API reference is a building block
